...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO limpeza(nome,quantidade,valor)
...
<head>
    ...
    <link rel="stylesheet" href="../style/prod-limpeza.css">
    <title>Limpeza</title>
</head>
...
<body>
    ...
    <div class="box">
        <form action="prod-limpeza.php" method="post">
            <h2>Cadastrar produtos de limpeza</h2><br><br>
